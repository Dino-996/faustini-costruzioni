    ...
    <v-container>
      ...
      <v-container fluid class="d-flex flex-wrap align-center justify-center">
        <div class="d-flex flex-wrap align-center justify-space-between">
          ...
          <v-skeleton-loader class="w-100" rounded="sm" :loading="!isLoading" type="card, text" color="transparent">
            <v-card elevation="5" rounded="sm" color="transparent" class="ml-5 mt-2" v-for="image in images"
              ...
              <v-img rounded="sm" :src="image.fileimage" :lazy-src="image.fileimage" height="300" width="300"
                :alt="image.title" class="text-center align-end cursor-pointer" @click="selectImage(image)"
                ...
                <span v-if="imageSelected && isSelectedImage.id == image.id" style="pointer-events: none;">
                  <v-btn class="mb-3" append-icon="mdi-eye-outline">Scopri di pi&ugrave;</v-btn>
                </span>
              </v-img>
            </v-card>
          </v-skeleton-loader>
          ...
          <v-overlay v-model="overlay" scroll-strategy="reposition" class="align-center justify-center" role="tooltip"
            ...
            <v-card rounded="sm" color="yellow-darken-2" elevation="5" width="380" height="667" class="overflow-y-auto">
              ...
              <template v-slot:append>
                <v-btn color="blue-darken-2" icon="mdi-close" variant="text"
...
const images = reactive([
  ...
  { id: 1, fileimage: 'https://firebasestorage.googleapis.com/v0/b/faustinicostruzioni-b5930.appspot.com/o/works%2FteatroCecilia%2Fwork4.webp?alt=media&token=71e9cc4a-530c-4562-98cb-5e12759c6d62', subfileimage: ['https://firebasestorage.googleapis.com/v0/b/faustinicostruzioni-b5930.appspot.com/o/works%2FteatroCecilia%2Fwork4.webp?alt=media&token=71e9cc4a-530c-4562-98cb-5e12759c6d62', 'https://firebasestorage.googleapis.com/v0/b/faustinicostruzioni-b5930.appspot.com/o/works%2FteatroCecilia%2Fwork1.webp?alt=media&token=293e5dac-8bdb-4737-8519-ed6e12a8a8a9', 'https://firebasestorage.googleapis.com/v0/b/faustinicostruzioni-b5930.appspot.com/o/works%2FteatroCecilia%2Fwork5.webp?alt=media&token=16516fc9-df21-48fa-ac43-afd6d7af4e89'], title: "Teatro Cecilia", subtitle: "Tito (PZ)", text: "Il Teatro Cecilia di Tito è un edificio storico situato in provincia di Potenza. Considerato il suo valore culturale e storico, l'obiettivo dell'intervento di efficientamento energetico è stato quello di migliorare la performance energetica dell'edificio riducendo consumi ed emissioni, senza compromettere l'integrità architettonica e storica dell'immobile." },
  ...
  { id: 3, fileimage: 'https://firebasestorage.googleapis.com/v0/b/faustinicostruzioni-b5930.appspot.com/o/works%2FgalleriaSanNicola%2Fwork7.webp?alt=media&token=3ff0bdc1-8f3e-4514-8ca1-c7bf815a4a27', subfileimage: ['https://firebasestorage.googleapis.com/v0/b/faustinicostruzioni-b5930.appspot.com/o/works%2FgalleriaSanNicola%2Fwork7.webp?alt=media&token=3ff0bdc1-8f3e-4514-8ca1-c7bf815a4a27', '../assets/faustini.mp4', 'https://firebasestorage.googleapis.com/v0/b/faustinicostruzioni-b5930.appspot.com/o/works%2FgalleriaSanNicola%2Fwork8.webp?alt=media&token=0954a9a4-7f20-4bda-8fb0-646523ffff77'], title: "Galleria San Nicola", subtitle: "SS 658 Potenza-Melfi", text: "Abbiamo realizzato interventi di manutenzione straordinaria per il rivestimento e il ripristino corticale della galleria San Nicola sulla SS 658 Potenza-Melfi. Il nostro team di professionisti ha lavorato con precisione e competenza, applicando materiali di alta qualità per risolvere problemi di usura, deterioramento e degrado delle superfici interne della galleria. La nostra esperienza e professionalità hanno permesso di completare i lavori nel rispetto dei tempi di realizzazione e delle normative vigenti, assicurando la conservazione e la manutenzione ottimale delle infrastrutture stradali." },
  { id: 4, fileimage: 'https://firebasestorage.googleapis.com/v0/b/faustinicostruzioni-b5930.appspot.com/o/works%2FviadottoSicignanoPotenza%2Fwork9.webp?alt=media&token=7a1c859c-f2cf-4b5c-a7b4-d4a8a0977ea2', subfileimage: ['https://firebasestorage.googleapis.com/v0/b/faustinicostruzioni-b5930.appspot.com/o/works%2FviadottoSicignanoPotenza%2Fwork9.webp?alt=media&token=7a1c859c-f2cf-4b5c-a7b4-d4a8a0977ea2', '../assets/viadotto.mp4'], title: "Viadotto autostradale", subtitle: "Raccordo autostradale Sicignano - Potenza", text: "Il ripristino con malta tixotropica delle pile di viadotti sul raccordo autostradale Sicignano - Potenza ha permesso di riparare e rinforzare le strutture danneggiate, garantendo la sicurezza e la durabilità delle pile nel tempo. Attraverso l'applicazione di soluzioni tecnologicamente avanzate e l'utilizzo di materiali di alta qualità, abbiamo contribuito a prolungare la vita utile dei viadotti, minimizzando i rischi di cedimenti strutturali e garantendo la continuità e l'efficienza del collegamento autostradale tra la Campania e la Basilicata." },
